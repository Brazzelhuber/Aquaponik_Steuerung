...
#####################################################
# Programm liest den Luxwert aus dem Sensor und schickt ihn über I2C Bus an Raspi

# Lichtmessen               # habe ich aus dem Internet abgekupfert, der LichtsensorBH1750 wird millionenfach in Handys verbaut
#!/usr/bin/python
